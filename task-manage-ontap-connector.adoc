...
+
--
https://docs.netapp.com/us-en/cloud-manager-backup-restore/concept-backup-to-cloud.html["Documentation sur la sauvegarde et la restauration"^]
...
+
--
https://docs.netapp.com/us-en/cloud-manager-data-sense/concept-cloud-compliance.html["Documentation de classification"^]
...
+
--
https://docs.netapp.com/us-en/cloud-manager-tiering/concept-cloud-tiering.html["Documentation sur la hiérarchisation"^]
