...
https://["En savoir plus sur les options de découverte et de gestion"].
...
https://["En savoir plus sur cette option de découverte et de gestion"].
...
https://["Découvrez comment afficher ces informations importantes sur le cluster sur site"]. Vous devez disposer d'un compte sur le site de support NetApp pour les clusters, et vous devez joindre les identifiants NSS à votre compte Cloud Manager.
